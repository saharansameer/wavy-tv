...
export const excludedTags = [
  ...
  // Gen Z / filler / slang words to exclude
  "yo", "bruh", "bro", "lmao", "rofl", "lol", "lmfao", "uh", "umm", "uhh",
  "omg", "yolo", "idk", "ikr", "smh", "tbh", "btw", "fml", "afaik", "fyi",
  "yeet", "sus", "nope", "nah", "cap", "fr", "deadass", "mood", "vibe",
  "vibes", "lowkey", "highkey", "bussin", "woke", "sheesh", "skrrt", "slay",
  "flex", "drip", "ratio", "based", "mid", "stan", "simp", "salty", "lit",
  "extra", "goat", "bet", "fam", "squad", "snatched", "tea", "shade",
  "okurrr", "periodt", "dank", "clout", "cancel", "canceled", "ghost", "ghosted"
];